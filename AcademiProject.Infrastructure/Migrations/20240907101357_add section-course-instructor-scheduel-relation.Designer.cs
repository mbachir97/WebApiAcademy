...
namespace RepositoryPaternWithUOW.EF.Migrations
{
    ...
    [Migration("20240907101357_add section-course-instructor-scheduel-relation")]
    partial class addsectioncourseinstructorscheduelrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RepositoryPaternWithUOW.Core.Model.Section", b =>
                {
                    ...
                    b.ToTable("Sections", null, t =>
                        {
                            t.Property("EndDate")
                                .HasColumnName("Section_EndDate");

                            t.Property("StartDate")
                                .HasColumnName("Section_StartDate");
                        });
                });
